...
public static class EnumerableExtensions
{
    ...
    public static IEnumerable<T> ShallowCopy<T>(this IEnumerable<T> toCopy) => new List<T>(toCopy);

    public static RangeObservableCollection<T> ToRangeObservableCollection<T>(this IEnumerable<T> enumerable) => new RangeObservableCollection<T>(enumerable);
